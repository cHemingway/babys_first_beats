...
# Connect button
button = DigitalInOut(board.EXTERNAL_BUTTON)
...
# Go to sleep until button is pressed
pixel.fill((0,0,0))
external_power.value = False
accel_int1.deinit() # release
accel_alarm = alarm.pin.PinAlarm(board.ACCELEROMETER_INTERRUPT, value=True)
button.deinit()
button_alarm = alarm.pin.PinAlarm(board.EXTERNAL_BUTTON, value=False, pull=True)
print("Going to sleep")
alarm.exit_and_deep_sleep_until_alarms(accel_alarm, button_alarm)
